  ...
  template<class t> using vvc=vc<vc<t>>;
    ...
    template <class T, class V> void _print(queue <T, V> q) {cout << "[ "; while(q.size()) {_print(q.front()); q.pop();  cout << " ";} cout << "]";}
    template <class T, class V> void _print(stack <T, V> st) {cout << "[ "; while(st.size()) {_print(st.top()); st.pop();  cout << " ";} cout << "]";}
    ...
    template <class T, class V> void _print(priority_queue <T, V> st) {cout << "[ "; while(st.size()) {_print(st.top()); st.pop();  cout << " ";} cout << "]";}
  // output
